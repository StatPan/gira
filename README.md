...
The 3.x release line is the CLI-first control-plane contract. It is not a
hosted dashboard, UI/TUI launch, provider expansion, or Gira-native planning
database. The current direction is documented in
[docs/current-product-direction.md](docs/current-product-direction.md).
