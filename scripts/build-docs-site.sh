...
for page in install quickstart jira-mapping jira-primary-provider ticket-workflow sprint-release distribution troubleshooting agent-operator-skill command-reference; do
