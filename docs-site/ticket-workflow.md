...
- Use Gira ticket lifecycle commands for view, status, start, PR, note, checks, wait, and finish work; use raw `gh` only when Gira has no lifecycle command or you intentionally need a low-level GitHub operation.
