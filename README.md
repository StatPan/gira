...
- `goal status`, `goal next`, `goal plan --dry-run|--apply`, and `goal finish`
  model a larger objective as an evidence-backed child-ticket graph with
  explicit human-review stop conditions.
