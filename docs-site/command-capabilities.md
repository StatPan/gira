...
| `gira pm observe` | none | `read` | `stable_json` | none | docs/pm-operating-policy.md, docs/goal-operating-model.md, docs-site/command-reference.md |
...
| `gira pm replan` | none | `apply_mutation` | `stable_json` | applies fingerprint-approved safe graph mutations and durable override/replan receipts; irreversible actions remain residual decisions | docs/pm-operating-policy.md, docs/goal-operating-model.md, docs-site/command-reference.md |
...
| `gira ticket new` | gira new, gira t new, gira t n | `apply_mutation` | `stable_json` | creates a GitHub issue, may set a native parent, and may optionally start it; --dry-run previews issue body, labels, and parent plan | README.md, docs-site/ticket-workflow.md, docs/dogfood.md |
